...
export default function PickupsOakridge() {
  const games = GAMES.filter((g) => g.location === "oakridge");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.locationRow}>
        <Pressable onPress={() => router.push("/(tabs)/pickups")}>
          <Text style={styles.arrow}>‹</Text>
        </Pressable>
        <Text style={styles.location}>Oakridge</Text>
        <Pressable onPress={() => router.push("/(tabs)/pickups/patio")}>
          <Text style={styles.arrow}>›</Text>
        </Pressable>
      </View>
